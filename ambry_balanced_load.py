...
class AmbryTasks(TaskSet):
    def on_start(self):
        ...
        # Hosts to be chosen randomly to send request for each task execution
        self.hosts = ("http://192.168.33.21:1174", "http://192.168.33.22:1174", "http://192.168.33.23:1174")

    # Override execute_task in TaskSet
    # This method will be called for each task execution
    def execute_task(self, task, *args, **kwargs):
        host = random.choice(self.hosts)
        self.locust.client = HttpSession(base_url=host)
        super(AmbryTasks, self).execute_task(task, *args, **kwargs)
